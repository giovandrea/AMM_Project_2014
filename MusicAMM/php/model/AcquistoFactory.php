...
class AcquistoFactory {
    ...
    public function &caricaAcquistiDaStmt(mysqli_stmt $stmt) {
        ...
        $bind = $stmt->bind_result(
                $row['acquisti_id'], $row['acquisti_idcd'], $row['acquisti_idcliente'], $row['acquisti_datainizio'], $row['acquisti_datafine'], $row['acquisti_costo'], $row['clienti_id'], $row['clienti_nome'], $row['clienti_cognome'], $row['clienti_email'], $row['clienti_numerotel'], $row['clienti_via'], $row['clienti_numero_civico'], $row['clienti_citta'], $row['clienti_username'], $row['clienti_password'], $row['cds_id'], $row['cds_idcaratterizzazione'], $row['cds_anno']);
